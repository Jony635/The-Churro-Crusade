...
var WASDcontrol = String(parameters['WASD Control'] || 'true');
var DisableF2F3F4 = String(parameters['Disable F2 F3 and F4'] || 'false');
var NoGamepad = String(parameters['Disable Gamepad'] || 'true');
var MouseDisabled = String(parameters['Disable Mouse'] || 'true');
var MouseDisabledCharMapMovement = String(parameters['Disable Mouse to Move Character on Map'] || 'true');
